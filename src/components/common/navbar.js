            ...
            <AppBar position="static"
                ...
                <Toolbar>
                    ...
                    <Typography className={classes.title} variant="h5" noWrap>
                        <IconButton onClick={handleLogoClick}  style={{ color:color }}>Tremo<HeadsetIcon style={{fontSize:'30px'}}/>o</IconButton>
          </Typography>
                    ...
                    <div className={classes.sectionDesktop}>
                        <IconButton style={{ fontSize:'20px' }} color="inherit" onClick={handleStudioClick}>
